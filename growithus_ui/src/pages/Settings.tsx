...
const StatusBadge: React.FC<{
  ...
  return (
    <span
      className={`ml-auto inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statusStyles[status]}`}
    >
      {status}
    </span>
  );
...
const Settings: React.FC = () => {
  ...
  const addNominee = () => {
    if (nominees.length < 2) {
      ...
      setNominees([
        ...nominees,
        { id: newId, name: "", relationship: "", email: "", phone: "" },
      ]);
    }
  };
  ...
  const loadUserProfileDetails = async () => {
    ...
    try {
      const response = await apiClient.get(
        `/user/userDetailsById/${user?.userId}`,
        {
          headers: {
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/50 p-6 sm:p-8">
            {activeTab === "profile" && (
              <div className="space-y-8 animate-fade-in">
                ...
                <div className="flex items-center space-x-6" style={{display:"none"}}>
                  <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 via-teal-500 to-emerald-600 rounded-full flex items-center justify-center text-white text-2xl font-semibold">
                    JD
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-400 rounded-lg bg-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg  ring-1 ring-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <input
                      type="tel"
                      value={UserProfile?.Contact[0]?.valueEncrypted ?? ""}
                      className="w-full px-4 py-3 rounded-lg ring-1 ring-gray-400  focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                  </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1 pl-8">
                    Your primary residential address for communication.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input
                      type="text"
                      defaultValue="123, Financial Street, Dalal Avenue"
                      className="w-full px-4 py-3 rounded-lg ring-1 ring-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                  </div>
                  <div>
                ...
                <div className="flex justify-end space-x-4 pt-4">
                  <button className="px-6 py-2 text-gray-700 rounded-lg ring-1 ring-gray-400 hover:bg-gray-300">
                    Cancel
                  </button>
              ...
              <div className="space-y-8 animate-fade-in">
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    Upload your documents for account verification. Status will
                    be updated after review.
                  </p>
                  ...
                  {kycStatus !== "Verified" && (
                    <div className="mt-6">
                      <label
                        htmlFor="kyc-upload"
                        className="cursor-pointer block w-full border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-emerald-500 transition-colors"
                      >
                  ...
                  <div className="flex justify-end mt-6">
                    <button
                      ...
                      disabled={!kycFile || kycStatus !== "Pending"}
                    >
                      {kycStatus === "Pending"
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {nominees.length < 2 && (
                      <button
                        onClick={addNominee}
                        className="flex items-center text-sm font-medium text-emerald-500 hover:text-emerald-700"
                      >
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    Designate up to two nominees for your account.
                  </p>
                  ...
                  <div className="space-y-8">
                    {nominees.map((nominee, index) => (
                      <div
                        key={nominee.id}
                        className="p-4 border border-gray-200 rounded-lg relative bg-gray-50/50"
                      >
